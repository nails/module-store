    ...
    public function execute()
    {
        ...
        $this->query('
            CREATE TABLE `{{NAILS_DB_PREFIX}}store_product` (
                ...
                `lead_time` int(11) unsigned NOT NULL DEFAULT 0,
        ...
        $this->query('
            CREATE TABLE `{{NAILS_DB_PREFIX}}store_product_download` (
                ...
                CONSTRAINT `{{NAILS_DB_PREFIX}}store_product_download_ibfk_4` FOREIGN KEY (`download_id`) REFERENCES `{{NAILS_DB_PREFIX}}cdn_object` (`id`)
            ) ENGINE=InnoDB DEFAULT CHARSET=utf8;
        ');
        $this->query('
            CREATE TABLE `{{NAILS_DB_PREFIX}}store_product_image` (
                ...
                CONSTRAINT `{{NAILS_DB_PREFIX}}store_product_image_ibfk_4` FOREIGN KEY (`image_id`) REFERENCES `{{NAILS_DB_PREFIX}}cdn_object` (`id`)
            ) ENGINE=InnoDB DEFAULT CHARSET=utf8;
        ');
        $this->query('
        ...
        $this->query('
            CREATE TABLE `{{NAILS_DB_PREFIX}}store_product_price` (
                ...
                CONSTRAINT `{{NAILS_DB_PREFIX}}store_product_price_ibfk_2` FOREIGN KEY (`modified_by`) REFERENCES `{{NAILS_DB_PREFIX}}user` (`id`) ON DELETE SET NULL,
